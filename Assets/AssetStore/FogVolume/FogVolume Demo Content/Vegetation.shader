...
Shader "Fog Volume/Vegetation" {
    Properties {
        ...
        _Backlight ("Back light", Range(0, 50)) = 45
        [HDR]_Backlightcolor ("Back light color", Color) = (0.9954361,1,0.6691177,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 normalLocal = (_BumpMap_var.rgb*faceSign);
...
////// Emissive:
                float node_5967 = 0.0;
                float3 emissive = lerp(((max(0,dot((-1*lightDirection),(i.normalDir*faceSign)))*0.5+0.5)*node_544*_Backlight*node_544*_Backlightcolor.rgb),float3(node_5967,node_5967,node_5967),isFrontFace);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float3 node_544 = (_MainTex_var.rgb*_Color.rgb); // Diffuse Color
                float node_5967 = 0.0;
                o.Emission = lerp(((max(0,dot((-1*lightDirection),(i.normalDir*faceSign)))*0.5+0.5)*node_544*_Backlight*node_544*_Backlightcolor.rgb),float3(node_5967,node_5967,node_5967),isFrontFace);
