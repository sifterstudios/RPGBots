...
namespace Michsky.LSS
{
    ...
    public class LoadingScreenEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(new GUIContent("Layout", "Layout"), customSkin.FindStyle("Toolbar Layout")))
                currentTab = 0;

            if (GUILayout.Button(new GUIContent("Hints", "Hints"), customSkin.FindStyle("Toolbar Hints")))
                currentTab = 1;

            if (GUILayout.Button(new GUIContent("Background", "Background"), customSkin.FindStyle("Toolbar Background")))
                currentTab = 2;
            ...
            {
                case 0:
                    GUILayout.Label("LAYOUT", customSkin.FindStyle("Header"));
                    ...
                    GUILayout.Space(18);
                    GUILayout.Label("FONT / COLORS", customSkin.FindStyle("Header"));
